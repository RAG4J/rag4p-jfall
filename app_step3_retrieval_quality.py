...
from rag4p.integrations.ollama.ollama_question_generator import OllamaQuestionGenerator
...
def main():
    ...
    # TODO 1: Inspect the prompt to generate the questions in class OllamaQuestionGenerator
...
def quality_for_all_documents():
    ...
    retriever = WeaviateRetriever(
        ...
        hybrid=False,
        collection_name="JfallOllamaMaxToken"
    )
