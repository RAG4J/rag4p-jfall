...
def main():
    weaviate_collections = [
        ...
        "JfallOllamaMaxToken",
        "JfallOllamaSemantic",
        "JfallOllamaMaxTokenSentence"  # Used a SplitterChain with MaxTokenSplitter and SentenceSplitter
    ]
    ...
    #  - JfallOllamaAiSentence uses the SentenceSplitter
    #  - JfallOllamaAiMaxToken uses the MaxTokenSplitter
    #  - JfallOllamaAiSemantic uses the SemanticSplitter
    #  - JfallOllamaAiMaxTokenSentence uses a SplitterChain with MaxTokenSplitter and SentenceSplitter.
...
def retrieve_answer(context: str, question: str) -> str:
    answer_generator = OllamaAnswerGenerator(access_ollama=access_ollama, model=MODEL_LLAMA3)
